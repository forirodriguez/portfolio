    ...
    <div className="bg-cream min-h-screen p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <section>
          <div className="bg-teal text-cream p-6 rounded-lg">
            ...
            <p className="text-lg mb-4">
              ...
              experiencia en negocios, mi pasión por la tecnología y todas esas
              horas en cursos aprendiendo cosas nuevas.
            </p>
            <p className="text-lg">
        ...
        <section className="mt-12 mb-12 bg-gold text-charcoal p-6 rounded-lg">
          ...
          <p className="text-lg">
            Mi aventura en el desarrollo es como una serie que no para de sacar
            temporadas nuevas. Cada día es un episodio diferente, lleno de
            desafíos y aprendizajes. Mi meta es seguir mezclando todo lo que sé
            y he vivido para crear cosas que no solo funcionen genial, sino que
            realmente hagan la diferencia en la vida de las personas.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-teal text-cream p-6 rounded-lg mb-6">
            ...
            <p>
              ...
              disciplina que construí levantando pesas es la misma que uso para
              levantar proyectos y mantenerme al día en este mundo tech.
            </p>
          </div>
