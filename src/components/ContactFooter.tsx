    ...
    <footer className="contact-footer">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="max-w-xl">
          ...
          <p className="mt-3 text-charcoal/80 leading-relaxed">{t.home.contactIntro}</p>
        </div>
        <Link href={MAILTO_URL} className="button-primary self-start md:self-center shrink-0">
          {t.nav.talk}<ArrowUpRight size={20} aria-hidden="true" />
        </Link>
      </div>
      <div className="flex flex-col sm:flex-row justify-between gap-4 border-t border-teal/20 mt-8 pt-5 text-sm">
